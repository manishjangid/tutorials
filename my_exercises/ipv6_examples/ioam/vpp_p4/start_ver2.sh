...
echo "** Opening terminals for S1 and S2 ***"
gnome-terminal --maximize --tab --working-directory="/home/osboxes/p4git/p4_tutorials/tutorials/my_exercises/ipv6_examples/ioam/vpp_p4/" -e 'sudo bash -c "lxc-attach -n S1 -v PS1=\"\e]2;lxc-S1\alxc-S1> \""'  --tab -e 'sudo bash -c "lxc-attach -n S1 -v PS1=\"\e]2;lxc-S1\alxc-S1> \""' --working-directory="/home/osboxes/p4git/p4_tutorials/tutorials/my_exercises/ipv6_examples/ioam/vpp_p4/"
gnome-terminal --maximize --tab --working-directory="/home/osboxes/p4git/p4_tutorials/tutorials/my_exercises/ipv6_examples/ioam/vpp_p4/" -e 'sudo bash -c "lxc-attach -n S2 -v PS1=\"\e]2;lxc-S2\alxc-S2> \""'  --tab -e 'sudo bash -c "lxc-attach -n S2 -v PS1=\"\e]2;lxc-S2\alxc-S2> \""' --working-directory="/home/osboxes/p4git/p4_tutorials/tutorials/my_exercises/ipv6_examples/ioam/vpp_p4/"
